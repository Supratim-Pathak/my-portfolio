  ...
  return (
    <div className="full-container flex">
      <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-4xl  font-[sans-serif]">
        <div>
          <h1 className="text-white-800 text-3xl font-extrabold">Let's Talk</h1>
            ...
            <ul className="mt-4">
              <li className="flex items-center">
                ...
                >
                  ...
                  <strong>supratimpathak@gmail.com</strong>
                </Link>
              </li>
            </ul>
          </div>
          <div className="mt-12">
            ...
            <ul className="flex mt-4 space-x-4">
              <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <a
                  href="https://www.facebook.com/profile.php?id=61565561250290"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                <Link
                  href="https://www.linkedin.com/in/supratim-pathak/"
                  target="_blank"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"

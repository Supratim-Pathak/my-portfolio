...
export const HTML5 = () => {
  return (
    <>
      <Image src="/Html.png" width={35} height={35} alt="Css" />
    </>
  );
};
export const CSS = () => {
...
export const JS = () => {
  return (
    <>
      <Image src="/Js.png" width={30} height={30} alt="Picture of the author" />
    </>
  );
};
export const NODE = () => {
  return (
    <>
      <Image src="/Node.png" width={30} height={30} alt="Node" />
    </>
  );
};
export const REACT = () => {
...
export const AWS = () => {
  return (
    <>
      <Image src="/AWS.png" width={35} height={35} alt="React" />
    </>
  );
};
export const DOCKER = () => {
  return (
    <>
      <Image src="/DOCKER.png" width={35} height={35} alt="React" />
    </>
  );
};
